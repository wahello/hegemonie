...
<section class="col2">
    ...
    <div class="large">
        ...
        <table>
            <thead>
            <tr><td class="title">Now</td>{% for r in Land.Stock.Usage %}<td>{{r}}</td>{% endfor %}</tr>
            </thead>
            <tbody>
            ...
            <tfoot>
            <tr><td class="title">Max</td>{% for r in Land.Stock.Actual %}<td>{{r}}</td>{% endfor %}</tr>
            </tfoot>
        </table>
    </div>
    ...
    <div class="large">
        ...
        <table>
            <thead>
            <tr><td class="title">Production</td>{% for r in Land.Production.Actual %}<td>{{r}}</td>{% endfor %}</tr>
            </thead>
            <tbody>

...
func (app *armyApp) Show(ctx context.Context, req *proto.ArmyId) (reply *proto.ArmyView, err error) {
	err = app.armyLock('r', req, func(_ *region.Region, _ *region.City, army *region.Army) error {
		reply = ShowArmy(app.w, army)
		return nil
	})
	return reply, err
}
...
func (app *armyApp) Flea(ctx context.Context, req *proto.ArmyId) (*proto.None, error) {
	return none, app.armyLock('w', req, func(r *region.Region, _ *region.City, a *region.Army) error {
		return a.Flea(r)
	})
}
...
func (app *armyApp) Move(ctx context.Context, req *proto.ArmyMoveReq) (*proto.None, error) {
	return none, app.armyLock('w', req.Id, func(r *region.Region, _ *region.City, a *region.Army) error {
